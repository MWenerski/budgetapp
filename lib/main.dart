            ...
            ElevatedButton(
              onPressed: () {
                print(globalUserName);
                 Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) =>DeleteAccountConfirmationDialog()),
                );
...
class DeleteAccountConfirmationDialog extends StatefulWidget {
  @override
  DeleteAccountConfirmationDialogState createState() =>
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (usernameController.text == a && isConfirmed) {
                  //budget_transactions.TransactionsDB().deleteTransactions();
